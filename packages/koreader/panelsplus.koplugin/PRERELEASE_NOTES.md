...
This is the road-map for next update, being the main focus to remove the *EXPERIMENTAL* tag to OCR support.
...
# DONE:
- (Opt-in Option) Panels+ trigger with double finger tab instead of always long press in case you have other plugins that uses the Long-press gestures in your panels. Thanks to @Pixxel123  in [a PR](#2)
...
## What's Changed
* Add two-finger tap as an alternative way to open panels by @Pixxel123 in https://github.com/KristanLaimon/PanelsPlus/pull/7

## New Contributors
* @Pixxel123 made their first contribution in https://github.com/KristanLaimon/PanelsPlus/pull/7

**Full Changelog**: https://github.com/KristanLaimon/PanelsPlus/compare/v1.4.0...v1.5.0-nightly
